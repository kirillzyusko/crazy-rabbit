...
const Block = () => {
    return (
            <G x={width - heightOfOneBlock} y={height - distanceWithRespectToGround} transform={{scale: blockScalability}}>
                ...
                <Path d="m18.2938,47.0229h6v271.53h-6z" fill="#976825" stroke="#6e441b" strokeWidth="2.5" transform="matrix(.70711,-.70711,.70711,.70711,0,0)"/>
                ...
                <Path d="m-21.7784,47.0221h40v271.53h-40z" fill="#cd9945" stroke="#6e441b" strokeWidth="2.5" transform="matrix(.70711,-.70711,.70711,.70711,0,0)"/>
                <Path d="m162.7871-134.6081h40v273h-40z" fill="#cd9945" stroke="#6e441b" strokeWidth="2.5" transform="rotate(45)"/>
